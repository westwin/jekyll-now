...
1. 员工从入职的第一天起, IT管理员/HR就分配一个用户名johndoe/password
2. johndoe在日常的办公中，需要校验用户名/密码的场景很多,johndoe不可避免的要使用:
    * 访问企业邮箱
    * 访问代码库，文档库，HR系统，OA系统，财务系统等众多部署在公司内部的软件
    * 访问部署在共有云上的SaaS系统
    * 远程办公通过VPN接入公司网络
3. 公司在慢慢壮大
...
1. 提供一个中心化的"身份认证"体系，统一集中管理员工身份
2. 各种软件/网络设备系统, 通过标准的SSO登录协议，来对接"身份认证"提醒，从而达到"只需输入一次密码，全都登录"的效果
3. 统一身份认证系统通常具备的功能包括:
...
![架构图](/idaas/images/true-sso-archi.jpg)

### Identity as a Service (IDaaS)

近几年"云"的发展推动，身份认证服务逐渐演变成一个SaaS化的服务，即IDaaS.
...
建立在一个中心化的信任体系架构之上. 举个公安局颁发身份证的例子，

1. 公安局充当一个中心化的权威机构,即IDP的角色: 它负责给所有居民颁发/校验"身份证".
2. 每个居民充当User的角色: 需要在公安局统一登记注册. 公安局颁发的"身份证"充当着Identity的角色
3. 每个居民可以携带"身份证"到酒店住店，到火车站坐火车. 酒店/火车站充当着Service Provider的角色
4. 酒店/火车站在给User提供服务的时候，需要验明你的Identity. 即酒店/火车站需要Trust公安局这个权威机构颁发的身份证

从传统的身份证延伸出来的其他各种Identity包括:
